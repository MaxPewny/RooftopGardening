...
public class Fertilizer : MonoBehaviour, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        RaycastHit hitInfo;
            ...
            if (Physics.Raycast(ray, out hitInfo, 1000, RaycastLayerMask))
            {
                ...
                {
                    Debug.Log("Fertilize Plant");
                    hitInfo.transform.gameObject.GetComponent<Plant>().FertilizePlant();
                }
            }
